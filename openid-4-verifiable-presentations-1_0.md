...
* `scope`: OPTIONAL. this parameter is defined in [@!RFC6749]. The wallet MAY allows verifiers to request presentation of Verifiable Credentials be utilizing a pre-defined scope value. See (#request_scope) for more details.
