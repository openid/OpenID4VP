...
This specification introduces a new token type, "VP Token", used as a generic container for Verifiable Presentations, that is returned in Authorization and Token Responses.
