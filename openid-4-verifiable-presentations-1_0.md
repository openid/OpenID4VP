...
* `scope`: OPTIONAL. this parameter is defined in [@!RFC6749]. The wallet MAY allow verifiers to request presentation of credentials by utilizing a pre-defined scope value. See (#request_scope) for more details.
