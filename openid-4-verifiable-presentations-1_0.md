...
The following is a non-normative example of a plaintext of a JWT Claims Set used in an Authorization Response that is encrypted and not signed:
...
The following is a non-normative example of a payload of the JWT used in the example above before base64url encoding and signing:
...
Here is a non-normative example of a payload of a Verifiable Presentation with a format identifier `jwt_vp_json`:
...
The following is a non-normative example of a payload of a JWT-based W3C Verifiable Credential that will be used through this section.
...
The following is a non-normative example of a payload of the VP in the `vp_token` parameter provided in the same response and referred to by the `presentation_submission` above:
...
The following is a non-normative example of a payload of an ID Token:
