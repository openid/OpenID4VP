...
* The verifier should ensure that the purpose complies with applicable law and relies on a permissible legal basis. 
...
## Use, Retention and Disclosure Limitation {#use_retention_and_disclosure_limitation}
