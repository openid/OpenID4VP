...
* JWS Compact Serialized unsigned requests: `openid4vp-v1-unsigned`
* JWS Compact Serialized signed requests: `openid4vp-v1-signed`
* JWS JSON Serialized multi RP requests: `openid4vp-v1-multisigned`
