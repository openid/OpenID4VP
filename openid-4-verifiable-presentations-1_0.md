...
* `authz_response_enc_pk`: OPTIONAL. A JWK [@!RFC7517] containing the public key the client wants the wallet to use as basis to encrypt the authorization response. 
